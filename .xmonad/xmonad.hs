...
rofi_launcher = spawn "rofi -no-lazy-grab -show drun -modi run,drun,window -theme $HOME/.config/rofi/themes/rounded-blue-dark.rasi"
...
defaults = def {
      ...
      -- hooks, layouts
       ...
       -- layoutHook = gaps [(L,10), (R,10), (U,50), (D,10)] $ spacingRaw False (Border 5 0 10 0) True (Border 0 10 0 10) True $ myLayout,
        ...
        layoutHook = gaps [(L,10), (R,10), (U,50), (D,20)] $ spacingRaw True (Border 10 10 10 10) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
